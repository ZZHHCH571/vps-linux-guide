...
export const vps_buy_guide: Lesson = {
    ...
    content: {
      ...
      recommendations: [
        ...
        {
          scenario: '搭建网络服务/反向代理',
          provider: '阿里云/腾讯云（海外节点）',
          config: '2核4G，10Mbps以上带宽，不限流量',
          reason: '跨境业务需要处理大量网络请求，2核保证并发处理能力，4G内存防止OOM。高带宽确保网速快，不限流量避免超额费用。建议选国内节点，延迟低、访问稳定。',
          price: '约100-200元/月'
        },
        {
      ...
      commands: [],
      commonMistakes: [
        { error: '买了国内服务器无法访问某些海外服务', cause: '国内服务器无法访问外网加速', solution: '代理需求选海外节点，如新加坡、日本' },
